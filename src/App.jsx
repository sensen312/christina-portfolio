        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8 text-left">
            <div className="bg-[#F8F9FA] p-10 border border-[#002B5B]/5 card-shadow rounded-sm relative overflow-hidden group hover:-translate-y-2">
              ...
              {/* Added EMT Certificate Download from public folder */}
              <div className="mt-6 pt-4 border-t border-[#002B5B]/10">
                <a 
                  ...
                  className="inline-flex items-center space-x-2 text-[#C5A059] hover:text-[#002B5B] transition-colors text-xs font-bold uppercase tracking-widest"
                >
                  <Download size={16} />
                ...
                <div className="space-y-4">
                  {category.papers.map((paper, pIdx) => (
                    <div key={pIdx} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 group bg-black/20 p-4 rounded-sm">
                      ...
                      {/* Changed from onClick alert to actual functional <a> tags pointing to public folder (/) */}
                      <a 
                        href={`/${paper.file}`}
                        download={paper.file}
                        target="_blank"
